...
/**
 Implementation of this struct by Basem Emara http://basememara.com/creating-thread-safe-arrays-in-swift
 */
...
public final class SynchronizedArray<Element> {
    ...
    fileprivate let queue = DispatchQueue(label: "cz.skiny.n.SynchronizedArray", attributes: .concurrent)
